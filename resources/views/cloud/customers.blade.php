    ...
    <table class="data-table">
        ...
        <tbody>
            <template x-if="filteredCustomers.length===0">
                <tr>
                    <td colspan="8" style="text-align:center;padding:40px;color:#94A3B8;">No customers found</td>
                </tr>
            </template>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div style="font-size:28px;font-weight:800;color:#10B981;"
                x-text="fmt(allCustomers.reduce((s,c)=>s+(c.wallet_balance||0),0))"></div>
            <div style="font-size:13px;color:#64748B;margin-top:4px;">Total wallet balance across all customers</div>
        </div>
    </div>
    <div class="card">
        <div class="card-header">
            <div class="card-title">Loyalty Summary</div>
        </div>
        <div class="card-body">
            <div style="font-size:28px;font-weight:800;color:#F59E0B;"
                x-text="fmtNum(allCustomers.reduce((s,c)=>s+(c.loyalty_balance||0),0))+' pts'"></div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div style="font-size:28px;font-weight:800;color:#6366F1;"
                x-text="allCustomers.filter(c=>c.orders_count>0).length"></div>
